...
export default function PrivacyPolicy() {
    return (
        <div>
            <Typography variant="h5">Privacy Policy for Print adjuster</Typography>
            ...
            <Typography paragraph>
                Print adjuster does not collect any personal data or information from you while using our app.
                We do not collect, store, or share any identifiable information about our users.
            </Typography>

            <Typography variant="h6">Usage Data:</Typography>
            <Typography paragraph>
                While using Print adjuster, we do not collect or track any usage data, including but not limited to your device information,
            ...
            <Typography paragraph>
                Print adjuster does not display any third-party advertisements, and therefore, we do not share any user information
                with advertisers or ad networks.
            </Typography>

            <Typography variant="h6">Updates to the Privacy Policy:</Typography>
            <Typography paragraph>
                As we continue to improve and enhance Print adjuster, there may be occasional updates to this privacy policy.
            ...
            <Typography paragraph>
                If you have any questions, concerns, or suggestions regarding our privacy policy or the practices of Print adjuster,
